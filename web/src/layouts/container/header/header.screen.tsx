...
import { SubProfile } from "libraries/components/sub-profile/sub-profile";

function HeaderScreen() {
  const { page, setPage, toggleMenu, hasMiniMenu, logoutApp, getUserInfo } =
    HeaderAdapter();
  ...
  return (
    <header className="tittlebar">
      ...
      <Route path={ENUM_PAGE.REPORT_SALES}>
      ...
      <div>
        ...
        <SubProfile {...{logoutApp, getUserInfo}}/>
      </div>
    </header>
  );
}
